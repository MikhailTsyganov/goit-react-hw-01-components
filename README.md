...
- [Задание 1 - Профиль социальной сети](./src/social-profile/)
- [Задание 2 - Секция статистики](./src/statistics/)
- [Задание 3 - Список друзей](./src/friend-list/)
- [Задание 4 - История транзакций](./src/transaction-history/)
